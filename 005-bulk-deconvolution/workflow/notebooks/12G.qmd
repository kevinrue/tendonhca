...
```{r inputfiles}
cellranger_filtered_matrix <- c("12G" = "../../../004-deconvolution/results/cellranger_count/12G/outs/filtered_feature_bc_matrix")
...
```{r}
demuxlet_file <- "../../../005-bulk-deconvolution/results/popscle_demuxlet/12G.best"
...
tmp_df
ggplot(tmp_df) +
  geom_violin(aes(x = summary, y = umi_sum), draw_quantiles = 0.5) +
