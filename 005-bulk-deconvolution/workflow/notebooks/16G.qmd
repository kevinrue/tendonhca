...
```{r inputfiles}
cellranger_filtered_matrix <- c("16G" = "../../../004-deconvolution/results/cellranger_count/16G/outs/filtered_feature_bc_matrix")
...
```{r}
demuxlet_file <- "../../../005-bulk-deconvolution/results/popscle_demuxlet/16G.best"
